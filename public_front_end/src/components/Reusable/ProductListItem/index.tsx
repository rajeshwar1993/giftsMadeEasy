  ...
  return (
    <div className='pt-4 transition-all duration-200 rounded-lg lg:p-4 lg:hover:shadow-2xl border-skin-primary border-opacity-0 lg:hover:border-opacity-30 border-2'>
      ...
      >
        ...
        <div className='flex flex-col items-center space-y-2 lg:space-y-0  justify-between w-full px-4 lg:px-0'>
          <Button
            icon={{
              iconName: 'LinkUrl'
            }}
            ...
            target='_blank'
          />
          <Button text='See Details' link={path} defautStyle='cust-btn-link' />
        </div>
