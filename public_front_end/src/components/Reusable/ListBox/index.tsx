    ...
    <Listbox value={selectedOption} onChange={so => onSelected(so, filterKey)}>
      ...
      <div className='relative mt-1 w-full' data-testid={dataTestId}>
        <Listbox.Button
          name={filterKey}
          id={filterKey}
          className={`relative w-full py-1 md:py-2 pl-3 pr-10 text-left bg-skin-fill text-skin-primary rounded-lg border-2 border-skin-inverted cursor-pointer focus:outline-none focus-visible:ring-3 focus-visible:ring-opacity-75 focus-visible:ring-white focus-visible:ring-offset-orange-300 focus-visible:ring-offset-2 focus-visible:border-indigo-500 text-sm ${buttonStyleClasses}`}
        >
